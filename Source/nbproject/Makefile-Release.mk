...
${OBJECTDIR}/BorneException.o: BorneException.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/BorneException.o BorneException.cpp
...
${OBJECTDIR}/BorneException_nomain.o: ${OBJECTDIR}/BorneException.o BorneException.cpp 
	${MKDIR} -p ${OBJECTDIR}
	@NMOUTPUT=`${NM} ${OBJECTDIR}/BorneException.o`; \
	if (echo "$$NMOUTPUT" | ${GREP} '|main$$') || \
	   (echo "$$NMOUTPUT" | ${GREP} 'T main$$') || \
	   (echo "$$NMOUTPUT" | ${GREP} 'T _main$$'); \
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/BorneException_nomain.o BorneException.cpp;\
	else  \
	    ${CP} ${OBJECTDIR}/BorneException.o ${OBJECTDIR}/BorneException_nomain.o;\
	fi
