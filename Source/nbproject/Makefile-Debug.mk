...
${OBJECTDIR}/BorneException.o: BorneException.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/BorneException.o BorneException.cpp
...
${OBJECTDIR}/BorneException_nomain.o: ${OBJECTDIR}/BorneException.o BorneException.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/BorneException_nomain.o BorneException.cpp;\
	else  \
